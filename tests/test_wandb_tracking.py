...
from coach_silvs.evolution import build_parser
from coach_silvs.wandb_tracking import WandbTracker
...
class WandbTrackingTests(unittest.TestCase):
    ...
    def test_wandb_tracking_defines_live_genome_and_vector_field_tables(self) -> None:
        source = Path(__file__).parents[1] / "src" / "coach_silvs" / "wandb_tracking.py"
    ...
    def test_cli_defaults_to_disabled_and_safe_upload_scope(self) -> None:
        ...
        self.assertEqual(args.wandb_project, "coach-silvs")
